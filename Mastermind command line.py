...
def drawboard(playerguesses, clues):
    ...
    print("O - correct letter but in the wrong position")
    print()

    for i in range(len(playerguesses)):  # cycle through right amount of lines, one per guess
        print(hline)
        for j in range(4):
